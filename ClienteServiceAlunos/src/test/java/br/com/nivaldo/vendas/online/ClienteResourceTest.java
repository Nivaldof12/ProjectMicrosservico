 ...
 * 
 */
package br.com.nivaldo.vendas.online;
...
import br.com.nivaldo.vendas.online.reources.ClienteResource;
import br.com.nivaldo.vendas.online.usecase.BuscaCliente;
import br.com.nivaldo.vendas.online.usecase.CadastroCliente;
...
public class ClienteResourceTest {
	...
	public void buscarPorId() {
		Cliente cliente1 = Cliente.builder().id("1").nome("Nivaldo 1").build();
